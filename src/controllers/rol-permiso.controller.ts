...
export class RolPermisoController {
  ...
  @get('/rols/{id}/permisos', {
    responses: {
      '200': {
        description: 'Array of Rol has many Permiso through RolPermiso',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.rolRepository.permisoRol(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.permisoRol(id).create(permiso);
  }
  ...
  async patch(
    ...
    return this.rolRepository.permisoRol(id).patch(permiso, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.permisoRol(id).delete(where);
  }
}
